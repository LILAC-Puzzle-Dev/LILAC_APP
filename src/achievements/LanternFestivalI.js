...
class LanternFestivalI {
    constructor() {
        // Metadata
        this.id = 'lantern-festival-i';
        this.name = 'Lantern Festival I';
        this.emoji = '🏮';
        this.color = '#2C82C9';
        this.rarity = 'Rare';
        ...
        // Requirements
        this.description = 'Get 4 points in 2026 Lantern Festival Puzzle I.';
        this.dependsOn = null;
    ...
    async check(member, userData) {
        const puzzleSubmission = await PuzzleSubmission.findOne({
            user_id: member.id,
            game_custom_id: "2026-lantern-festival-one",
...
module.exports = LanternFestivalI;